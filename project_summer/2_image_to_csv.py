...
csv_path = "./data/csv/Biceps_curl/AVG/177/Biceps_curl1.csv"
#圖片位置
parser.add_argument("--image_dir", default="./data/imgs/from_video/Biceps_curl/Biceps_curl177/Biceps_curl1", help="Process a directory of images. Read all standard formats (jpg, png, bmp, etc.).")
#def write_csv()
try:
