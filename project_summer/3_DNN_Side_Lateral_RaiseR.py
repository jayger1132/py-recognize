...
df_ready = pd.read_csv('./data/csv/Side_Lateral_RaiseR/Side_Lateral_RaiseR_Ready.csv')
df_ready['target'] = TARGET_READY
df_start = pd.read_csv('./data/csv/Side_Lateral_RaiseR/Side_Lateral_RaiseR_Start.csv')
df_start['target'] = TARGET_START


df_ready_test = pd.read_csv('./data/csv/Side_Lateral_RaiseR/Side_Lateral_RaiseR_Ready_Test.csv')
df_ready_test['target'] = TARGET_READY
df_start_test = pd.read_csv('./data/csv/Side_Lateral_RaiseR/Side_Lateral_RaiseR_Start_Test.csv')
...
model.save('./data/model/model_Side_Lateral_RaiseR')
